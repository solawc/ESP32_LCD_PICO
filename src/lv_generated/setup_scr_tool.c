...
void setup_scr_tool(lv_ui *ui){
	...
	lv_style_set_bg_color(&style_tool_main_main_default, lv_color_make(0x1d, 0x23, 0x32));
	...
	//Write codes tool_imgbtn_1
	ui->tool_imgbtn_1 = lv_imgbtn_create(ui->tool);
	lv_obj_set_pos(ui->tool_imgbtn_1, 99, 112);
	lv_obj_set_size(ui->tool_imgbtn_1, 114, 114);
	lv_obj_set_scrollbar_mode(ui->tool_imgbtn_1, LV_SCROLLBAR_MODE_OFF);

	//Write style state: LV_STATE_DEFAULT for style_tool_imgbtn_1_main_main_default
	static lv_style_t style_tool_imgbtn_1_main_main_default;
	if (style_tool_imgbtn_1_main_main_default.prop_cnt > 1)
		lv_style_reset(&style_tool_imgbtn_1_main_main_default);
	else
		lv_style_init(&style_tool_imgbtn_1_main_main_default);
	lv_style_set_text_color(&style_tool_imgbtn_1_main_main_default, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_align(&style_tool_imgbtn_1_main_main_default, LV_TEXT_ALIGN_CENTER);
	lv_style_set_img_recolor(&style_tool_imgbtn_1_main_main_default, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_img_recolor_opa(&style_tool_imgbtn_1_main_main_default, 0);
	lv_style_set_img_opa(&style_tool_imgbtn_1_main_main_default, 255);
	lv_obj_add_style(ui->tool_imgbtn_1, &style_tool_imgbtn_1_main_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write style state: LV_STATE_PRESSED for style_tool_imgbtn_1_main_main_pressed
	static lv_style_t style_tool_imgbtn_1_main_main_pressed;
	if (style_tool_imgbtn_1_main_main_pressed.prop_cnt > 1)
		lv_style_reset(&style_tool_imgbtn_1_main_main_pressed);
	else
		lv_style_init(&style_tool_imgbtn_1_main_main_pressed);
	lv_style_set_text_color(&style_tool_imgbtn_1_main_main_pressed, lv_color_make(0xFF, 0x33, 0xFF));
	lv_style_set_text_align(&style_tool_imgbtn_1_main_main_pressed, LV_TEXT_ALIGN_CENTER);
	lv_style_set_img_recolor(&style_tool_imgbtn_1_main_main_pressed, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_img_recolor_opa(&style_tool_imgbtn_1_main_main_pressed, 0);
	lv_style_set_img_opa(&style_tool_imgbtn_1_main_main_pressed, 255);
	lv_obj_add_style(ui->tool_imgbtn_1, &style_tool_imgbtn_1_main_main_pressed, LV_PART_MAIN|LV_STATE_PRESSED);

	//Write style state: LV_STATE_CHECKED for style_tool_imgbtn_1_main_main_checked
	static lv_style_t style_tool_imgbtn_1_main_main_checked;
	if (style_tool_imgbtn_1_main_main_checked.prop_cnt > 1)
		lv_style_reset(&style_tool_imgbtn_1_main_main_checked);
	else
		lv_style_init(&style_tool_imgbtn_1_main_main_checked);
	lv_style_set_text_color(&style_tool_imgbtn_1_main_main_checked, lv_color_make(0xFF, 0x33, 0xFF));
	lv_style_set_text_align(&style_tool_imgbtn_1_main_main_checked, LV_TEXT_ALIGN_CENTER);
	lv_style_set_img_recolor(&style_tool_imgbtn_1_main_main_checked, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_img_recolor_opa(&style_tool_imgbtn_1_main_main_checked, 0);
	lv_style_set_img_opa(&style_tool_imgbtn_1_main_main_checked, 255);
	lv_obj_add_style(ui->tool_imgbtn_1, &style_tool_imgbtn_1_main_main_checked, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_imgbtn_set_src(ui->tool_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, &_tool_info_alpha_114x114, NULL);
	lv_obj_add_flag(ui->tool_imgbtn_1, LV_OBJ_FLAG_CHECKABLE);

	//Write codes tool_imgbtn_2
	ui->tool_imgbtn_2 = lv_imgbtn_create(ui->tool);
	lv_obj_set_pos(ui->tool_imgbtn_2, 268, 112);
	lv_obj_set_size(ui->tool_imgbtn_2, 114, 114);
	...
	lv_imgbtn_set_src(ui->tool_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, &_tool_wifi_alpha_114x114, NULL);
	lv_obj_add_flag(ui->tool_imgbtn_2, LV_OBJ_FLAG_CHECKABLE);

	//Write codes tool_label_1
	ui->tool_label_1 = lv_label_create(ui->tool);
	lv_obj_set_pos(ui->tool_label_1, 15, 28);
	lv_obj_set_size(ui->tool_label_1, 60, 18);
	lv_obj_set_scrollbar_mode(ui->tool_label_1, LV_SCROLLBAR_MODE_OFF);
	lv_label_set_text(ui->tool_label_1, "Tools");
	...
	lv_style_set_text_color(&style_tool_label_1_main_main_default, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_text_font(&style_tool_label_1_main_main_default, &lv_font_montserratMedium_18);
	...
	lv_obj_set_pos(ui->tool_imgbtn_3, 420, 17);
	lv_obj_set_size(ui->tool_imgbtn_3, 25, 21);
	...
	lv_imgbtn_set_src(ui->tool_imgbtn_3, LV_IMGBTN_STATE_RELEASED, NULL, &_return_alpha_25x21, NULL);
