...
void setup_scr_engraving(lv_ui *ui){
	...
	lv_style_set_shadow_width(&style_engraving_imgbtn_1_main_main_default, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_1_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_1_main_main_default, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_1_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_1_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_1_main_main_default, 0);		
	...
	lv_style_set_shadow_width(&style_engraving_imgbtn_1_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_1_main_main_pressed, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_1_main_main_pressed, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_1_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_1_main_main_pressed, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_1_main_main_pressed, 0);		
	...
	lv_style_set_shadow_width(&style_engraving_imgbtn_1_main_main_checked, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_1_main_main_checked, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_1_main_main_checked, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_1_main_main_checked, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_1_main_main_checked, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_1_main_main_checked, 0);		
	...
	lv_imgbtn_set_src(ui->engraving_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, &_Slice_41_alpha_184x184, NULL);
	...
	//Write codes engraving_imgbtn_7
	ui->engraving_imgbtn_7 = lv_imgbtn_create(ui->engraving);
	lv_obj_set_pos(ui->engraving_imgbtn_7, 112, 86);
	lv_obj_set_size(ui->engraving_imgbtn_7, 15, 30);
	lv_obj_set_scrollbar_mode(ui->engraving_imgbtn_7, LV_SCROLLBAR_MODE_OFF);

	//Write style state: LV_STATE_DEFAULT for style_engraving_imgbtn_7_main_main_default
	static lv_style_t style_engraving_imgbtn_7_main_main_default;
	if (style_engraving_imgbtn_7_main_main_default.prop_cnt > 1)
		lv_style_reset(&style_engraving_imgbtn_7_main_main_default);
	else
		lv_style_init(&style_engraving_imgbtn_7_main_main_default);
	lv_style_set_shadow_width(&style_engraving_imgbtn_7_main_main_default, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_7_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_7_main_main_default, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_7_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_7_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_7_main_main_default, 0);
	lv_style_set_text_color(&style_engraving_imgbtn_7_main_main_default, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_align(&style_engraving_imgbtn_7_main_main_default, LV_TEXT_ALIGN_CENTER);
	lv_style_set_img_recolor(&style_engraving_imgbtn_7_main_main_default, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_img_recolor_opa(&style_engraving_imgbtn_7_main_main_default, 0);
	lv_style_set_img_opa(&style_engraving_imgbtn_7_main_main_default, 255);
	lv_obj_add_style(ui->engraving_imgbtn_7, &style_engraving_imgbtn_7_main_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write style state: LV_STATE_PRESSED for style_engraving_imgbtn_7_main_main_pressed
	static lv_style_t style_engraving_imgbtn_7_main_main_pressed;
	if (style_engraving_imgbtn_7_main_main_pressed.prop_cnt > 1)
		lv_style_reset(&style_engraving_imgbtn_7_main_main_pressed);
	else
		lv_style_init(&style_engraving_imgbtn_7_main_main_pressed);
	lv_style_set_shadow_width(&style_engraving_imgbtn_7_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_7_main_main_pressed, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_7_main_main_pressed, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_7_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_7_main_main_pressed, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_7_main_main_pressed, 0);
	lv_style_set_text_color(&style_engraving_imgbtn_7_main_main_pressed, lv_color_make(0xFF, 0x33, 0xFF));
	lv_style_set_img_recolor(&style_engraving_imgbtn_7_main_main_pressed, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_img_recolor_opa(&style_engraving_imgbtn_7_main_main_pressed, 0);
	lv_style_set_img_opa(&style_engraving_imgbtn_7_main_main_pressed, 255);
	lv_obj_add_style(ui->engraving_imgbtn_7, &style_engraving_imgbtn_7_main_main_pressed, LV_PART_MAIN|LV_STATE_PRESSED);

	//Write style state: LV_STATE_CHECKED for style_engraving_imgbtn_7_main_main_checked
	static lv_style_t style_engraving_imgbtn_7_main_main_checked;
	if (style_engraving_imgbtn_7_main_main_checked.prop_cnt > 1)
		lv_style_reset(&style_engraving_imgbtn_7_main_main_checked);
	else
		lv_style_init(&style_engraving_imgbtn_7_main_main_checked);
	lv_style_set_shadow_width(&style_engraving_imgbtn_7_main_main_checked, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_7_main_main_checked, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_7_main_main_checked, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_7_main_main_checked, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_7_main_main_checked, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_7_main_main_checked, 0);
	lv_style_set_text_color(&style_engraving_imgbtn_7_main_main_checked, lv_color_make(0xFF, 0x33, 0xFF));
	lv_style_set_img_recolor(&style_engraving_imgbtn_7_main_main_checked, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_img_recolor_opa(&style_engraving_imgbtn_7_main_main_checked, 0);
	lv_style_set_img_opa(&style_engraving_imgbtn_7_main_main_checked, 255);
	lv_obj_add_style(ui->engraving_imgbtn_7, &style_engraving_imgbtn_7_main_main_checked, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_imgbtn_set_src(ui->engraving_imgbtn_7, LV_IMGBTN_STATE_RELEASED, NULL, &_y_up_alpha_15x30, NULL);
	lv_obj_add_flag(ui->engraving_imgbtn_7, LV_OBJ_FLAG_CHECKABLE);

	//Write codes engraving_imgbtn_8
	ui->engraving_imgbtn_8 = lv_imgbtn_create(ui->engraving);
	lv_obj_set_pos(ui->engraving_imgbtn_8, 112, 189);
	lv_obj_set_size(ui->engraving_imgbtn_8, 15, 30);
	lv_obj_set_scrollbar_mode(ui->engraving_imgbtn_8, LV_SCROLLBAR_MODE_OFF);

	//Write style state: LV_STATE_DEFAULT for style_engraving_imgbtn_8_main_main_default
	static lv_style_t style_engraving_imgbtn_8_main_main_default;
	if (style_engraving_imgbtn_8_main_main_default.prop_cnt > 1)
		lv_style_reset(&style_engraving_imgbtn_8_main_main_default);
	else
		lv_style_init(&style_engraving_imgbtn_8_main_main_default);
	lv_style_set_shadow_width(&style_engraving_imgbtn_8_main_main_default, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_8_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_8_main_main_default, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_8_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_8_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_8_main_main_default, 0);
	lv_style_set_text_color(&style_engraving_imgbtn_8_main_main_default, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_align(&style_engraving_imgbtn_8_main_main_default, LV_TEXT_ALIGN_CENTER);
	lv_style_set_img_recolor(&style_engraving_imgbtn_8_main_main_default, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_img_recolor_opa(&style_engraving_imgbtn_8_main_main_default, 0);
	lv_style_set_img_opa(&style_engraving_imgbtn_8_main_main_default, 255);
	lv_obj_add_style(ui->engraving_imgbtn_8, &style_engraving_imgbtn_8_main_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write style state: LV_STATE_PRESSED for style_engraving_imgbtn_8_main_main_pressed
	static lv_style_t style_engraving_imgbtn_8_main_main_pressed;
	if (style_engraving_imgbtn_8_main_main_pressed.prop_cnt > 1)
		lv_style_reset(&style_engraving_imgbtn_8_main_main_pressed);
	else
		lv_style_init(&style_engraving_imgbtn_8_main_main_pressed);
	lv_style_set_shadow_width(&style_engraving_imgbtn_8_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_8_main_main_pressed, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_8_main_main_pressed, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_8_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_8_main_main_pressed, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_8_main_main_pressed, 0);
	lv_style_set_text_color(&style_engraving_imgbtn_8_main_main_pressed, lv_color_make(0xFF, 0x33, 0xFF));
	lv_style_set_img_recolor(&style_engraving_imgbtn_8_main_main_pressed, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_img_recolor_opa(&style_engraving_imgbtn_8_main_main_pressed, 0);
	lv_style_set_img_opa(&style_engraving_imgbtn_8_main_main_pressed, 255);
	lv_obj_add_style(ui->engraving_imgbtn_8, &style_engraving_imgbtn_8_main_main_pressed, LV_PART_MAIN|LV_STATE_PRESSED);

	//Write style state: LV_STATE_CHECKED for style_engraving_imgbtn_8_main_main_checked
	static lv_style_t style_engraving_imgbtn_8_main_main_checked;
	if (style_engraving_imgbtn_8_main_main_checked.prop_cnt > 1)
		lv_style_reset(&style_engraving_imgbtn_8_main_main_checked);
	else
		lv_style_init(&style_engraving_imgbtn_8_main_main_checked);
	lv_style_set_shadow_width(&style_engraving_imgbtn_8_main_main_checked, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_8_main_main_checked, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_8_main_main_checked, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_8_main_main_checked, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_8_main_main_checked, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_8_main_main_checked, 0);
	lv_style_set_text_color(&style_engraving_imgbtn_8_main_main_checked, lv_color_make(0xFF, 0x33, 0xFF));
	lv_style_set_img_recolor(&style_engraving_imgbtn_8_main_main_checked, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_img_recolor_opa(&style_engraving_imgbtn_8_main_main_checked, 0);
	lv_style_set_img_opa(&style_engraving_imgbtn_8_main_main_checked, 255);
	lv_obj_add_style(ui->engraving_imgbtn_8, &style_engraving_imgbtn_8_main_main_checked, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_imgbtn_set_src(ui->engraving_imgbtn_8, LV_IMGBTN_STATE_RELEASED, NULL, &_y_down_alpha_15x30, NULL);
	lv_obj_add_flag(ui->engraving_imgbtn_8, LV_OBJ_FLAG_CHECKABLE);

	//Write codes engraving_imgbtn_9
	ui->engraving_imgbtn_9 = lv_imgbtn_create(ui->engraving);
	lv_obj_set_pos(ui->engraving_imgbtn_9, 53, 145);
	lv_obj_set_size(ui->engraving_imgbtn_9, 28, 15);
	lv_obj_set_scrollbar_mode(ui->engraving_imgbtn_9, LV_SCROLLBAR_MODE_OFF);

	//Write style state: LV_STATE_DEFAULT for style_engraving_imgbtn_9_main_main_default
	static lv_style_t style_engraving_imgbtn_9_main_main_default;
	if (style_engraving_imgbtn_9_main_main_default.prop_cnt > 1)
		lv_style_reset(&style_engraving_imgbtn_9_main_main_default);
	else
		lv_style_init(&style_engraving_imgbtn_9_main_main_default);
	lv_style_set_shadow_width(&style_engraving_imgbtn_9_main_main_default, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_9_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_9_main_main_default, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_9_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_9_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_9_main_main_default, 0);
	lv_style_set_text_color(&style_engraving_imgbtn_9_main_main_default, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_align(&style_engraving_imgbtn_9_main_main_default, LV_TEXT_ALIGN_CENTER);
	lv_style_set_img_recolor(&style_engraving_imgbtn_9_main_main_default, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_img_recolor_opa(&style_engraving_imgbtn_9_main_main_default, 0);
	lv_style_set_img_opa(&style_engraving_imgbtn_9_main_main_default, 255);
	lv_obj_add_style(ui->engraving_imgbtn_9, &style_engraving_imgbtn_9_main_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write style state: LV_STATE_PRESSED for style_engraving_imgbtn_9_main_main_pressed
	static lv_style_t style_engraving_imgbtn_9_main_main_pressed;
	if (style_engraving_imgbtn_9_main_main_pressed.prop_cnt > 1)
		lv_style_reset(&style_engraving_imgbtn_9_main_main_pressed);
	else
		lv_style_init(&style_engraving_imgbtn_9_main_main_pressed);
	lv_style_set_shadow_width(&style_engraving_imgbtn_9_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_9_main_main_pressed, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_9_main_main_pressed, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_9_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_9_main_main_pressed, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_9_main_main_pressed, 0);
	lv_style_set_text_color(&style_engraving_imgbtn_9_main_main_pressed, lv_color_make(0xFF, 0x33, 0xFF));
	lv_style_set_img_recolor(&style_engraving_imgbtn_9_main_main_pressed, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_img_recolor_opa(&style_engraving_imgbtn_9_main_main_pressed, 0);
	lv_style_set_img_opa(&style_engraving_imgbtn_9_main_main_pressed, 255);
	lv_obj_add_style(ui->engraving_imgbtn_9, &style_engraving_imgbtn_9_main_main_pressed, LV_PART_MAIN|LV_STATE_PRESSED);

	//Write style state: LV_STATE_CHECKED for style_engraving_imgbtn_9_main_main_checked
	static lv_style_t style_engraving_imgbtn_9_main_main_checked;
	if (style_engraving_imgbtn_9_main_main_checked.prop_cnt > 1)
		lv_style_reset(&style_engraving_imgbtn_9_main_main_checked);
	else
		lv_style_init(&style_engraving_imgbtn_9_main_main_checked);
	lv_style_set_shadow_width(&style_engraving_imgbtn_9_main_main_checked, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_9_main_main_checked, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_9_main_main_checked, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_9_main_main_checked, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_9_main_main_checked, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_9_main_main_checked, 0);
	lv_style_set_text_color(&style_engraving_imgbtn_9_main_main_checked, lv_color_make(0xFF, 0x33, 0xFF));
	lv_style_set_img_recolor(&style_engraving_imgbtn_9_main_main_checked, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_img_recolor_opa(&style_engraving_imgbtn_9_main_main_checked, 0);
	lv_style_set_img_opa(&style_engraving_imgbtn_9_main_main_checked, 255);
	lv_obj_add_style(ui->engraving_imgbtn_9, &style_engraving_imgbtn_9_main_main_checked, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_imgbtn_set_src(ui->engraving_imgbtn_9, LV_IMGBTN_STATE_RELEASED, NULL, &_x_left_alpha_28x15, NULL);
	lv_obj_add_flag(ui->engraving_imgbtn_9, LV_OBJ_FLAG_CHECKABLE);

	//Write codes engraving_imgbtn_10
	ui->engraving_imgbtn_10 = lv_imgbtn_create(ui->engraving);
	lv_obj_set_pos(ui->engraving_imgbtn_10, 159, 145);
	lv_obj_set_size(ui->engraving_imgbtn_10, 28, 15);
	lv_obj_set_scrollbar_mode(ui->engraving_imgbtn_10, LV_SCROLLBAR_MODE_OFF);

	//Write style state: LV_STATE_DEFAULT for style_engraving_imgbtn_10_main_main_default
	static lv_style_t style_engraving_imgbtn_10_main_main_default;
	if (style_engraving_imgbtn_10_main_main_default.prop_cnt > 1)
		lv_style_reset(&style_engraving_imgbtn_10_main_main_default);
	else
		lv_style_init(&style_engraving_imgbtn_10_main_main_default);
	lv_style_set_shadow_width(&style_engraving_imgbtn_10_main_main_default, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_10_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_10_main_main_default, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_10_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_10_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_10_main_main_default, 0);
	lv_style_set_text_color(&style_engraving_imgbtn_10_main_main_default, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_align(&style_engraving_imgbtn_10_main_main_default, LV_TEXT_ALIGN_CENTER);
	lv_style_set_img_recolor(&style_engraving_imgbtn_10_main_main_default, lv_color_make(0xff, 0xff, 0xff));
	lv_style_set_img_recolor_opa(&style_engraving_imgbtn_10_main_main_default, 0);
	lv_style_set_img_opa(&style_engraving_imgbtn_10_main_main_default, 255);
	lv_obj_add_style(ui->engraving_imgbtn_10, &style_engraving_imgbtn_10_main_main_default, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write style state: LV_STATE_PRESSED for style_engraving_imgbtn_10_main_main_pressed
	static lv_style_t style_engraving_imgbtn_10_main_main_pressed;
	if (style_engraving_imgbtn_10_main_main_pressed.prop_cnt > 1)
		lv_style_reset(&style_engraving_imgbtn_10_main_main_pressed);
	else
		lv_style_init(&style_engraving_imgbtn_10_main_main_pressed);
	lv_style_set_shadow_width(&style_engraving_imgbtn_10_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_10_main_main_pressed, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_10_main_main_pressed, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_10_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_10_main_main_pressed, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_10_main_main_pressed, 0);
	lv_style_set_text_color(&style_engraving_imgbtn_10_main_main_pressed, lv_color_make(0xFF, 0x33, 0xFF));
	lv_style_set_img_recolor(&style_engraving_imgbtn_10_main_main_pressed, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_img_recolor_opa(&style_engraving_imgbtn_10_main_main_pressed, 0);
	lv_style_set_img_opa(&style_engraving_imgbtn_10_main_main_pressed, 255);
	lv_obj_add_style(ui->engraving_imgbtn_10, &style_engraving_imgbtn_10_main_main_pressed, LV_PART_MAIN|LV_STATE_PRESSED);

	//Write style state: LV_STATE_CHECKED for style_engraving_imgbtn_10_main_main_checked
	static lv_style_t style_engraving_imgbtn_10_main_main_checked;
	if (style_engraving_imgbtn_10_main_main_checked.prop_cnt > 1)
		lv_style_reset(&style_engraving_imgbtn_10_main_main_checked);
	else
		lv_style_init(&style_engraving_imgbtn_10_main_main_checked);
	lv_style_set_shadow_width(&style_engraving_imgbtn_10_main_main_checked, 0);
	lv_style_set_shadow_color(&style_engraving_imgbtn_10_main_main_checked, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_engraving_imgbtn_10_main_main_checked, 255);
	lv_style_set_shadow_spread(&style_engraving_imgbtn_10_main_main_checked, 0);
	lv_style_set_shadow_ofs_x(&style_engraving_imgbtn_10_main_main_checked, 0);
	lv_style_set_shadow_ofs_y(&style_engraving_imgbtn_10_main_main_checked, 0);
	lv_style_set_text_color(&style_engraving_imgbtn_10_main_main_checked, lv_color_make(0xFF, 0x33, 0xFF));
	lv_style_set_img_recolor(&style_engraving_imgbtn_10_main_main_checked, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_img_recolor_opa(&style_engraving_imgbtn_10_main_main_checked, 0);
	lv_style_set_img_opa(&style_engraving_imgbtn_10_main_main_checked, 255);
	lv_obj_add_style(ui->engraving_imgbtn_10, &style_engraving_imgbtn_10_main_main_checked, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_imgbtn_set_src(ui->engraving_imgbtn_10, LV_IMGBTN_STATE_RELEASED, NULL, &_x_right_alpha_28x15, NULL);
	lv_obj_add_flag(ui->engraving_imgbtn_10, LV_OBJ_FLAG_CHECKABLE);

	//Write codes engraving_label_1
	ui->engraving_label_1 = lv_label_create(ui->engraving);
	lv_obj_set_pos(ui->engraving_label_1, 10, 5);
	lv_obj_set_size(ui->engraving_label_1, 80, 20);
	lv_obj_set_scrollbar_mode(ui->engraving_label_1, LV_SCROLLBAR_MODE_OFF);
	lv_label_set_text(ui->engraving_label_1, "MakeGo");
	...
	lv_style_set_bg_color(&style_engraving_label_1_main_main_default, lv_color_make(0x1D, 0x23, 0x32));
	...
	lv_style_set_bg_opa(&style_engraving_label_1_main_main_default, 255);
	...
	lv_style_set_text_font(&style_engraving_label_1_main_main_default, &lv_font_montserratMedium_10);
	...
	lv_style_set_text_align(&style_engraving_label_1_main_main_default, LV_TEXT_ALIGN_CENTER);
