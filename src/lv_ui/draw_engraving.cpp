...
void setup_scr_engraving_page(ui_t *ui) {
	...
	lv_style_set_text_font(&style_engraving_page_btn_frame_main_main_default, &lv_font_montserrat_16);
	...
	lv_style_set_text_font(&style_engraving_page_btn_home_main_main_default, &lv_font_montserrat_16);
	...
	lv_style_set_text_font(&style_engraving_page_btn_position_main_main_default, &lv_font_montserrat_16);
	...
	lv_style_set_text_font(&style_engraving_page_btn_start_main_main_default, &lv_font_montserrat_16);
	...
	// lv_style_set_text_font(&style_engraving_page_label_1_main_main_default, &lv_font_montserrat_16);
	...
	// lv_style_set_text_font(&style_engraving_page_label_2_main_main_default, &lv_font_montserrat_16);
	...
	// lv_style_set_text_font(&style_engraving_page_btn_5_main_main_default, &lv_font_montserrat_16);
