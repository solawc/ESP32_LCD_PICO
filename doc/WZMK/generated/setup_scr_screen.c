...
void setup_scr_screen(lv_ui *ui){
	...
	lv_style_set_bg_color(&style_screen_main_main_default, lv_color_make(0x1D, 0x23, 0x32));
	...
	lv_obj_set_pos(ui->screen_imgbtn_1, 38, 112);
	lv_obj_set_size(ui->screen_imgbtn_1, 114, 114);
	...
	lv_style_set_shadow_opa(&style_screen_imgbtn_1_main_main_default, 0);
	...
	lv_style_set_text_color(&style_screen_imgbtn_1_main_main_default, lv_color_make(0xee, 0xe1, 0xe1));
	...
	lv_imgbtn_set_src(ui->screen_imgbtn_1, LV_IMGBTN_STATE_RELEASED, NULL, &_pic_engraving_114x114, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_1, LV_IMGBTN_STATE_PRESSED, NULL, &_pic_engraving_114x114, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_1, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_pic_engraving_114x114, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_1, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_pic_engraving_114x114, NULL);
	...
	lv_obj_set_pos(ui->screen_imgbtn_2, 183, 112);
	lv_obj_set_size(ui->screen_imgbtn_2, 114, 114);
	...
	lv_style_set_shadow_width(&style_screen_imgbtn_2_main_main_default, 0);
	lv_style_set_shadow_color(&style_screen_imgbtn_2_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_screen_imgbtn_2_main_main_default, 255);
	lv_style_set_shadow_spread(&style_screen_imgbtn_2_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_screen_imgbtn_2_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_screen_imgbtn_2_main_main_default, 0);
	lv_style_set_text_color(&style_screen_imgbtn_2_main_main_default, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_align(&style_screen_imgbtn_2_main_main_default, LV_TEXT_ALIGN_CENTER);
	...
	lv_style_set_shadow_width(&style_screen_imgbtn_2_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_screen_imgbtn_2_main_main_pressed, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_screen_imgbtn_2_main_main_pressed, 255);
	lv_style_set_shadow_spread(&style_screen_imgbtn_2_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_screen_imgbtn_2_main_main_pressed, 0);
	lv_style_set_shadow_ofs_y(&style_screen_imgbtn_2_main_main_pressed, 0);
	...
	lv_style_set_img_opa(&style_screen_imgbtn_2_main_main_pressed, 255);
	...
	lv_style_set_shadow_width(&style_screen_imgbtn_2_main_main_checked, 0);
	lv_style_set_shadow_color(&style_screen_imgbtn_2_main_main_checked, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_screen_imgbtn_2_main_main_checked, 255);
	lv_style_set_shadow_spread(&style_screen_imgbtn_2_main_main_checked, 0);
	lv_style_set_shadow_ofs_x(&style_screen_imgbtn_2_main_main_checked, 0);
	lv_style_set_shadow_ofs_y(&style_screen_imgbtn_2_main_main_checked, 0);
	...
	lv_style_set_img_opa(&style_screen_imgbtn_2_main_main_checked, 255);
	lv_obj_add_style(ui->screen_imgbtn_2, &style_screen_imgbtn_2_main_main_checked, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_imgbtn_set_src(ui->screen_imgbtn_2, LV_IMGBTN_STATE_RELEASED, NULL, &_pic_control_alpha_114x114, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_2, LV_IMGBTN_STATE_PRESSED, NULL, &_pic_control_alpha_114x114, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_2, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_pic_control_alpha_114x114, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_2, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_pic_control_alpha_114x114, NULL);
	...
	lv_obj_set_pos(ui->screen_imgbtn_3, 328, 112);
	lv_obj_set_size(ui->screen_imgbtn_3, 114, 114);
	...
	if (style_screen_imgbtn_3_main_main_default.prop_cnt > 1)
		lv_style_reset(&style_screen_imgbtn_3_main_main_default);
	else
		lv_style_init(&style_screen_imgbtn_3_main_main_default);
	lv_style_set_shadow_width(&style_screen_imgbtn_3_main_main_default, 0);
	lv_style_set_shadow_color(&style_screen_imgbtn_3_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_screen_imgbtn_3_main_main_default, 255);
	lv_style_set_shadow_spread(&style_screen_imgbtn_3_main_main_default, 0);
	lv_style_set_shadow_ofs_x(&style_screen_imgbtn_3_main_main_default, 0);
	lv_style_set_shadow_ofs_y(&style_screen_imgbtn_3_main_main_default, 0);
	lv_style_set_text_color(&style_screen_imgbtn_3_main_main_default, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_align(&style_screen_imgbtn_3_main_main_default, LV_TEXT_ALIGN_CENTER);
	...
	if (style_screen_imgbtn_3_main_main_pressed.prop_cnt > 1)
		lv_style_reset(&style_screen_imgbtn_3_main_main_pressed);
	else
		lv_style_init(&style_screen_imgbtn_3_main_main_pressed);
	lv_style_set_shadow_width(&style_screen_imgbtn_3_main_main_pressed, 0);
	lv_style_set_shadow_color(&style_screen_imgbtn_3_main_main_pressed, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_screen_imgbtn_3_main_main_pressed, 255);
	lv_style_set_shadow_spread(&style_screen_imgbtn_3_main_main_pressed, 0);
	lv_style_set_shadow_ofs_x(&style_screen_imgbtn_3_main_main_pressed, 0);
	lv_style_set_shadow_ofs_y(&style_screen_imgbtn_3_main_main_pressed, 0);
	...
	lv_style_set_img_opa(&style_screen_imgbtn_3_main_main_pressed, 255);
	...
	if (style_screen_imgbtn_3_main_main_checked.prop_cnt > 1)
		lv_style_reset(&style_screen_imgbtn_3_main_main_checked);
	else
		lv_style_init(&style_screen_imgbtn_3_main_main_checked);
	lv_style_set_shadow_width(&style_screen_imgbtn_3_main_main_checked, 0);
	lv_style_set_shadow_color(&style_screen_imgbtn_3_main_main_checked, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_shadow_opa(&style_screen_imgbtn_3_main_main_checked, 255);
	lv_style_set_shadow_spread(&style_screen_imgbtn_3_main_main_checked, 0);
	lv_style_set_shadow_ofs_x(&style_screen_imgbtn_3_main_main_checked, 0);
	lv_style_set_shadow_ofs_y(&style_screen_imgbtn_3_main_main_checked, 0);
	...
	lv_style_set_img_opa(&style_screen_imgbtn_3_main_main_checked, 255);
	lv_obj_add_style(ui->screen_imgbtn_3, &style_screen_imgbtn_3_main_main_checked, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_imgbtn_set_src(ui->screen_imgbtn_3, LV_IMGBTN_STATE_RELEASED, NULL, &_pic_tool_alpha_114x114, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_3, LV_IMGBTN_STATE_PRESSED, NULL, &_pic_tool_alpha_114x114, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_3, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_pic_tool_alpha_114x114, NULL);
	lv_imgbtn_set_src(ui->screen_imgbtn_3, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_pic_tool_alpha_114x114, NULL);
	lv_obj_add_flag(ui->screen_imgbtn_3, LV_OBJ_FLAG_CHECKABLE);

	//Write codes screen_label_1
	ui->screen_label_1 = lv_label_create(ui->screen);
	lv_obj_set_pos(ui->screen_label_1, 38, 226);
	lv_obj_set_size(ui->screen_label_1, 114, 32);
	lv_obj_set_scrollbar_mode(ui->screen_label_1, LV_SCROLLBAR_MODE_OFF);
	lv_label_set_text(ui->screen_label_1, "Engraving");
	...
	lv_obj_set_pos(ui->screen_label_2, 183, 226);
	lv_obj_set_size(ui->screen_label_2, 114, 32);
	lv_obj_set_scrollbar_mode(ui->screen_label_2, LV_SCROLLBAR_MODE_OFF);
	lv_label_set_text(ui->screen_label_2, "Control");
	...
	lv_obj_set_pos(ui->screen_label_3, 328, 226);
	lv_obj_set_size(ui->screen_label_3, 114, 32);
	lv_obj_set_scrollbar_mode(ui->screen_label_3, LV_SCROLLBAR_MODE_OFF);
	lv_label_set_text(ui->screen_label_3, "Tool");
